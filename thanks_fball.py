...
def main():
    ...
    prior_players_df_path = api.create_prior_players_file_path(year, week - 1, output_dir)

    # Check if prior week players data exists, if not create it (notice week - 1)
    prior_players_df = api.check_prior_players_file_exists(year, week - 1, prior_players_df_path)
